...
with tf.device(device_A):
    ...
    baby = load_model('../scripts/models/baby.net')
    ...
    girder = load_model('../scripts/models/girder.net')
    gird_op = (1 - girder([1 - ip1 / 255.0, ip4, 1 - ip3 / 255.0])) * 255.0

    reader = load_model('../scripts/models/reader.net')
    features = reader(ip3 / 255.0)
    featuresx = reader(ip3x / 255.0)

    head = load_model('../scripts/models/head.net')
    ...
    neck = load_model('../scripts/models/neck.net')
...
with tf.device(device_B):
    ...
    tail = load_model('../scripts/models/tail.net')
    pads = 7
...
tail.load_weights('../scripts/models/tail.net')
baby.load_weights('../scripts/models/baby.net')
head.load_weights('../scripts/models/head.net')
neck.load_weights('../scripts/models/neck.net')
girder.load_weights('../scripts/models/girder.net')
reader.load_weights('../scripts/models/reader.net')
